...
const FreelancerChats = () => {
  ...
  // make fetchChats reusable so Refresh can call it
  ...
  const filtered = chats.filter((c) => {
    ...
    const name = c.clientId?.name || c.clientId?.email || "";
          ...
          {loading ? (
            ...
            <ul className="divide-y divide-gray-100">
              {filtered.map((c) => {
                ...
                const name = c.clientId?.name || c.clientId?.email || "Client";
                ...
                return (
                  <li
                    ...
                    onClick={() => navigate(`/freelancer/chats/${pid}`)}
                  >
            ...
            <div className="p-6 text-center text-gray-500">
              ...
              <p className="text-sm mt-2">When a client invites you to a project or sends a message, conversations will appear here.</p>
              <div className="mt-4">
